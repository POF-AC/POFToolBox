...
/**
 * This class describes the relation between the angle beta and theta phi of a area light source.
 * 
 * @author Thomas Becker
 *
 */
public class AngularTransformationBeta2TP2Area implements Function3D
{
	/**
	 * Fiber properties
	 */
	 ...
	 */
	public AngularTransformationBeta2TP2Area(FiberProps a_fp)
	{
		fp = a_fp;
	}
	...
	public double getValue(double a_dblTZ, double a_dblTP) 
    {
		...
		dbl2 = 2*Math.pow(Math.sin(a_dblTP), 2);
        return dbl2;
    }
}
